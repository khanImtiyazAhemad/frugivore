...
FrugivoreOriginalsModel productSearchModelFromJson(String str) =>
    FrugivoreOriginalsModel.fromJson(json.decode(str));

String productSearchModelToJson(FrugivoreOriginalsModel data) =>
    json.encode(data.toJson());

class FrugivoreOriginalsModel {
  FrugivoreOriginalsModel({
    this.page,
    this.maxPage,
    this.count,
    this.next,
  ...
  factory FrugivoreOriginalsModel.fromJson(Map<String, dynamic> json) =>
      FrugivoreOriginalsModel(
        page: json["page"],
