...
import 'package:frugivore/services/purchaseItems.dart';
import 'package:frugivore/models/purchaseItems.dart';

class PurchaseItemsController extends GetxController {
  ...
  final _data = PurchaseItemsModel().obs;
  PurchaseItemsModel get data => _data.value;
  ...
  void apicall(qsp) async {
    try {
      isLoader(true);
      var response = await Services.fetchPurchaseItems(qsp);
      if (response != null) {
