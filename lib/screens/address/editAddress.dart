                          ...
                          child: controller.isLoader.value
                              ...
                              : Column(
                                  children: [
                                    Column(children: [
                                                                          CustomTitleBar(
                                      title: "Edit Address", search: false),
                                                                          Card(
                                      margin: plr10,
                                                                  ...
                                                                  children: [
                                                                    ...
                                                                    Container(
                                                                        ...
                                                                        child: TextField(
                                                                            ...
                                                                            style: TextStyle(fontSize: 12),
                                                                            decoration: controller.inputDecoration("Mobile Number")))
                                                                  ])
                                                            ])),
                                                        SizedBox(width: 10),
                                                        Expanded(
                                                                  ...
                                                                  children: [
                                                                    ...
                                                                    Container(
                                                                        ...
                                                                        decoration:
                                                                            shapeDecoration,
                                                                        child: TextField(
                                                                            controller: controller.alternatePhoneNumber,
                                                                            style: TextStyle(fontSize: 12),
                                                                            decoration: controller.inputDecoration("Alternate Phone Number")))
                                                                  ])
                                                            ]))
                                                      ],
                                                    ),
