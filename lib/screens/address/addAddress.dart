...
import 'package:frugivore/controllers/address/add_address.dart';
                                                                  ...
                                                                  children: [
                                                                    Container(
                                                                        width: MediaQuery.of(context).size.width *
                                                                            .1,
                                                                        decoration:
                                                                            boxDecoration.copyWith(color: bodyColor),
                                                                        padding: EdgeInsets.fromLTRB(5, 10, 5, 10),
                                                                        child: Text("+91", style: TextStyle(fontSize: 12))),
                                                                    Container(
                                                                        width: MediaQuery.of(context).size.width *
                                                                            .33,
                                                                        padding:
                                                                        ...
                                                                        decoration:
                                                                            shapeDecoration,
                                                                        child:
                                                                            TextField(controller: controller.mobileNumber, style:TextStyle(fontSize: 12), decoration: controller.inputDecoration("Mobile Number")))
                                                                  ])
                                                            ])),
                                                        SizedBox(width: 10),
                                                        Expanded(
                                                          ...
                                                          child: ListTile(
                                                            contentPadding:
                                                                EdgeInsets
                                                                    .all(0),
                                                            title: Text(
                                                                "Work",style:TextStyle(fontSize: 12), ),
                                                            leading: Radio(
                                                                activeColor:
                                                                    pinkColor,
                                                                value:
                                                          ...
                                                          child: ListTile(
                                                            contentPadding:
                                                                EdgeInsets
                                                                    .all(0),
                                                            title: Text(
                                                                "Other",style:TextStyle(fontSize: 12), ),
                                                            leading: Radio(
                                                                activeColor:
                                                                    pinkColor,
                                                                value:
