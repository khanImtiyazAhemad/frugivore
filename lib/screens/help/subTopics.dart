...
import 'package:frugivore/controllers/help/subTopics.dart';

import 'package:frugivore/connectivity.dart';

class HelpSubTopicsPage extends StatelessWidget {
  const HelpSubTopicsPage({super.key});

  @override
  Widget build(BuildContext context) {
    final controller = Get.put(SubTopicsController());
    return Scaffold(
        appBar: CustomAppBar(),
        drawer: CustomDrawer(),
        body: SmartRefresher(
                                            ...
                                            children: controller.data
                                              ...
                                              return GestureDetector(
                                                ...
                                                onTap: () => item.subSubTopics!
                                                    ? Navigator.pushNamed(
                                                        context,
                                                        "/help-sub-subtopics/${item.uuid}", arguments: [item.subTopic])
                                                    : Navigator.pushNamed(
                                                        context,
                                                        "/help-subtopic-detail/${item.uuid}", arguments: [item.subSubTopics])
                                              );
                                            }).toList(),
                                          ))),
