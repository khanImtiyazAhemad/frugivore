...
import 'package:frugivore/controllers/subscription/createSubscriptionPlan.dart';
...
class CreateSubscriptionPlanPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final controller =
      Get.put(CreateSubscriptionPlanController());
    return Scaffold(
        appBar: CustomAppBar(),
        drawer: CustomDrawer(),
...
class StartsOnCard extends StatefulWidget {
  const StartsOnCard({super.key});

  @override
  StartsOnCardState createState() => StartsOnCardState();
}

class StartsOnCardState extends State<StartsOnCard> {
          ...
          Padding(
            ...
            child: Row(
              children: [
                Expanded(
                  flex: 9,
                  child: Text(controller.data.deliveryAddress!.completeAddress ?? ""),
                ),
                Expanded(
                  flex: 1,
                  child: IconButton(
...
class MakePaymentPopup extends StatelessWidget {
  const MakePaymentPopup({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return AlertDialog(
        ...
        content: SingleChildScrollView(
          ...
          SizedBox(height: 20),
          Text(
              "Your Current Wallet Money Balance : Rs. ${controller.data.moneyBalance}"),
          SizedBox(height: 20),
          Text(
              "*We will suggest you to save this as draft before making payment to save your changes. Otherwise you will lost all your changes.",
              textAlign: TextAlign.center,
