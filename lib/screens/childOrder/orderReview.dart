...
import 'package:frugivore/controllers/childOrder/order_review.dart';

import 'package:frugivore/connectivity.dart';

class ChildOrderReviewPage extends StatelessWidget {
  const ChildOrderReviewPage({super.key});
  ...
  Widget build(BuildContext context) {
    final controller =
      Get.put(ChildOrderReviewController());
    return Scaffold(
